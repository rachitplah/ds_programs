...
int main()
{
	...
	int choice,flag=1;
	cout<<"Enter 1 to insert an element at a specified position"<<endl
	    <<"Enter 2 to delete an element whose position is given"<<endl
		<<"Enter 3 to find the location of an element"<<endl
		<<"Enter 4 to display the elements of the linear array"<<endl
		<<"Enter 5 to exit the menu"<<endl;
	cin>>choice;
	while(choice!=5)
	{
		switch(choice)
